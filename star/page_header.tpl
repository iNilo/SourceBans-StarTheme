	...
	{if $logged_in}
		...
		<script>
			...
			$( document ).ready(function()
			{
				...
				$.ajax(
						{
							url: "https://clwo.eu/jailbreak/api/v2/accounthelper.php",
							type: 'GET',
							cache: true,
							data: {SteamID2: $steamid },
							timeout: 4500,
						}).done(function ($data, $textStatus, $jqXHR)
				{
					//console.log($data.SteamData.avatar);
					$('.loggedin_avatar').attr("src", $data.SteamData.avatarfull);
					$('.loggedin_avatar').attr("alt", $data.SteamData.personaname);
				});
			});
			{/literal}
		</script>
				...
				{if $logged_in}
					<li class="nav-item dropdown ">
						<a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
							...
							<img class="img-xs rounded-circle loggedin_avatar" src='' alt="profile image">
						</a>
					...
					{if $logged_in}
						<div class="user-wrapper">
							<div class="profile-image">
								<img class="loggedin_avatar" src='' alt="profile image">
							</div>
